const API_KEY = "72e628efa553be4ebbe5bc093ec5c5f2";
...
const loadImages = ({ weather: [{ description }] }) => {
    const containerImg = document.querySelector("body");
    ...
    if (imageSrc) {
      ...
      imgElement.addEventListener("load", () => {
        containerImg.style.backgroundImage = `url('${imageSrc}')`;
      });
...
const onSearchChange = async(event) =>{
    ...
    if(value && (selectedCityText !== value)){
        ...
        let listOfCities = await getCities(value);
        let options = "";
